...
class Platform extends Component {
    ...
    render () {
        if (this.state.loading) {
            ...
            return (
                <li>
                    <h2><a style={{fontSize: '28px', margin: '4px', padding: "0px 0px"}} href={'/software/'+this.state.software+"/"+this.state.name+'/'} target="_blank" rel="noopener noreferrer">{this.state.name}</a></h2>
                    <ul className="horizontalbar-centered">
...
class Version extends Component {
    ...
    render () {
        return (
            <li>
                <a style={{fontSize: '24px', margin: '4px', padding: "0px 0px"}} href={'/software/'+this.state.software+"/"+this.state.platform+"/"+this.state.name+'/'} target="_blank" rel="noopener noreferrer">{this.state.name}</a>
            </li>
        )
    }
}